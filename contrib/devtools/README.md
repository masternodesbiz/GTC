...
GastroCoin-Project/GastroCoin repository.
...
Setup
---------
Configuring the github-merge tool for the GastroCoin repository is done in the following way:

    git config githubmerge.repository GastroCoin-Project/GastroCoin
...
A script to optimize png files in the GastroCoin
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_gastrocoin: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_gastrocoin: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_gastrocoin: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_gastrocoin: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
