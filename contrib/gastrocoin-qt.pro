...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/gastrocoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/gastrocoin-cli.cpp \
           src/gastrocoin-tx.cpp \
           src/gastrocoin.cpp \
           src/db.cpp \
           ...
           src/qt/gastrocoin.cpp \
           src/qt/gastrocoinstrings.cpp \
...
RESOURCES += src/qt/gastrocoin.qrc src/qt/gastrocoin_locale.qrc

TRANSLATIONS += src/qt/locale/gastrocoin_bg.ts \
                src/qt/locale/gastrocoin_de.ts \
                src/qt/locale/gastrocoin_en.ts \
                src/qt/locale/gastrocoin_es.ts \
                src/qt/locale/gastrocoin_fi.ts \
                src/qt/locale/gastrocoin_fr.ts \
                src/qt/locale/gastrocoin_it.ts \
                src/qt/locale/gastrocoin_ja.ts \
                src/qt/locale/gastrocoin_pl.ts \
                src/qt/locale/gastrocoin_pt.ts \
                src/qt/locale/gastrocoin_ru.ts \
                src/qt/locale/gastrocoin_sk.ts \
                src/qt/locale/gastrocoin_sv.ts \
                src/qt/locale/gastrocoin_vi.ts \
                src/qt/locale/gastrocoin_zh_CN.ts \
                src/qt/locale/gastrocoin_zh_TW.ts
