...
#define MyAppName "Gastrocoin Core"
#define MyAppPublisher "2021-2022 The Gastrocoin Developers"
#define MyAppURL "https://github.com/TeamGastroCoin/gastrocoin"
#define MyAppExeName "gtc-qt.exe"
#define MyAppExtraData "https://github.com/TeamGastroCoin/gastrocoin/releases/download/v2.0/bootstrap.zip"
...
DefaultDirName={autopf}\Gastrocoin
...
OutputDir=.\output
OutputBaseFilename=GastrocoinSetup
...
DefaultGroupName=Gastrocoin Core
...
[Files]
Source: ".\package\gtc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Gastrocoin\Gastrocoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Gastrocoin\Gastrocoin-Qt,strDataDir|{userappdata}\Gastrocoin\}');
  Result := True;
end;
