...
* Fill in the following data:
    * Application Name: `Gastrocoin Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The Gastrocoin Developers`
    * Application Website: `https://gastrocoin.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Gastrocoin`
* Add application files:
    * Select the file `gtc-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `gtc-2.0.0-win64-setup.exe`
