...
"""Verify that starting gtc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gtc with -? for help text")
        ...
        self.log.info("Start gtc with -version for version information")
