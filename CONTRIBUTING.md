Contributing to Gastrocoin Core
============================

The Gastrocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gastrocoin Core project, and is not to be
confused with overall Gastrocoin Network Protocol consensus changes.

Whether a pull request is merged into Gastrocoin Core rests with the project merge
...
Patches that change Gastrocoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Gastrocoin consensus, it must have been
...
The project leader is the release manager for each Gastrocoin Core release.
