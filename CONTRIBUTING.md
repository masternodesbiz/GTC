Contributing to GastroCoin
============================

The GastroCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the GastroCoin project, and is not to be
confused with overall GastroCoin Network Protocol consensus changes.

Whether a pull request is merged into GastroCoin rests with the project merge
...
Where a patch set proposes to change the GastroCoin consensus, it must have been
...
The project leader is the release manager for each GastroCoin release.
