    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of GTC earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 GTC");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair GTC, zGTC
