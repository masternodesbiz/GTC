...
/** Class encapsulating Gastrocoin Core startup and shutdown.
...
{
    QMessageBox::critical(0, "Runaway exception", QObject::tr("A fatal error occurred. Gastrocoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
/// 2. Basic Qt initialization (not dependent on parameters or configuration)
    ...
    // gtc: links repeatedly have their payment requests routed to this process:
