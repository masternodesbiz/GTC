...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GastroCoin gastrocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gastrocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gastrocoin transaction") + "\n" +
                               "  gastrocoin-tx [options] -create [commands]   " + _("Create hex-encoded gastrocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gastrocoin transaction
