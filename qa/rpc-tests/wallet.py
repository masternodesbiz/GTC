...
#   c) node1 mines 32 blocks, so now node 0 has 60001GTC, node 1 has 4250GTC, node2 has none.
#   d) node0 sends 601 GTC to node2, in two transactions (301 GTC, then 300 GTC).
