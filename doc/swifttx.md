...
This mechanism has been integrated into Bitcore-Node-GastroCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GastroCoin-Project/insight-api-gastrocoin#web-socket-api](https://github.com/GastroCoin-Project/insight-api-gastrocoin#web-socket-api) 
* API: [https://github.com/GastroCoin-Project/insight-api-gastrocoin#swifttx-transactions](https://github.com/GastroCoin-Project/insight-api-gastrocoin#swifttx-transactions) 
...
By default, the GastroCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GastroCoin daemon:
