...
In order to support loading of multiple wallets in gastrocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gastrocoin.cpp.
...
Changes to gastrocoin.cpp
----------------------
gastrocoin.cpp is the entry point into gastrocoin-qt, and as such, will require some minor modifications to provide hooks for
